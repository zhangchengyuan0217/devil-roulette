...
- **1920×1080+**：牌桌中轴约 `1320`；座位角色约 `124×194`；手牌约 `104×144`
- **2560×1440+**：牌桌中轴约 `1560`；座位角色约 `140×220`；手牌约 `118×164`
- 手牌悬停（桌面）：约 `translateY(-22px) scale(1.08)` + `.hand-preview`
- 预览大图：桌面约 `200×280`；FHD+ / 2K 见 `css/style.css` 大屏 media；手机横屏约 `100×140`
- 手牌选中：上移固定 + 金边；普通道具单选，铁玫瑰最多 2 张

## 改动后自测清单

- [ ] 桌面 1280×720 / 1920×1080 / 2560×1440：无纵向滚动条；大屏中轴不过空、手牌与底栏完整
- [ ] 道具手牌四角完整可见；悬停预览正常
